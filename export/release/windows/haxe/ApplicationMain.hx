...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FriendsEngine", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("FriendsEngine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "15";
		app.meta["company"] = "Alieazinho";
		app.meta["file"] = "FriendsEngine";
		app.meta["name"] = "Friday Night Funkin': Friends Engine";
		app.meta["packageName"] = "com.aleazinho.friendsengine";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Friends Engine",
			width: 1280,
			x: null,
			y: null,
		};
		...
		#elseif air
		app.window.title = "Friday Night Funkin': Friends Engine";
		#else
